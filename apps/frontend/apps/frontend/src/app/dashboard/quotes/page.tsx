...
export default function QuotesDashboard() {
  // TODO: Add backend API hooks (e.g. useQuotesMetrics())
    ...
    <DashboardShell>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold font-heading text-neutral-0 tracking-tight capitalize">quotes Overview</h1>
