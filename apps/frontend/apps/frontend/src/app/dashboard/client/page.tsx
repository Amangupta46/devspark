...
export default function ClientDashboard() {
  // TODO: Add backend API hooks (e.g. useClientMetrics())
    ...
    <DashboardShell>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold font-heading text-neutral-0 tracking-tight capitalize">client Overview</h1>
