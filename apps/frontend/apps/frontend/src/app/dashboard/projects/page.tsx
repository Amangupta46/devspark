...
export default function ProjectsDashboard() {
  // TODO: Add backend API hooks (e.g. useProjectsMetrics())
    ...
    <DashboardShell>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold font-heading text-neutral-0 tracking-tight capitalize">projects Overview</h1>
