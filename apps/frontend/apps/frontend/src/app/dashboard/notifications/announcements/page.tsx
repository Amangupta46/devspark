    ...
    <DashboardShell>
      ...
      >
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold font-heading text-neutral-0 capitalize">announcements</h1>
        ...
        const { data, isLoading } = useQuery({ queryKey: ['notifications'], queryFn: async () => [] });
