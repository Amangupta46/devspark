...
export default function NotificationsDashboard() {
  // TODO: Add backend API hooks (e.g. useNotificationsMetrics())
    ...
    <DashboardShell>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold font-heading text-neutral-0 tracking-tight capitalize">notifications Overview</h1>
