      ...
      <div className="flex w-full flex-col gap-1.5">
        ...
        <div className="relative flex items-center">
          <select
            ref={ref}
            className={cn(
              "bg-surface-base text-neutral-0 flex h-10 w-full cursor-pointer appearance-none rounded-md border px-3 py-2 pr-10 text-sm transition-all duration-200 outline-none",
              hasError
