export function HeroMobileFallback() {
  return (
    <div
      className="pointer-events-none absolute inset-0 overflow-hidden rounded-[2.5rem] bg-neutral-950/80 select-none"
      aria-hidden="true"
      style={{
        background: "linear-gradient(135deg, hsla(222,22%,10%,1) 0%, hsla(222,22%,5%,1) 100%)",
    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          ...
          style={{
            background: "radial-gradient(circle, hsla(37,93%,55%,0.3) 0%, transparent 70%)",
            animation: "pulse-hero-glow 6s ease-in-out infinite",
          }}
        />
        <div
          className="hero-orb-system absolute top-1/2 left-1/2 h-[400px] w-[400px] -translate-x-1/4 -translate-y-1/4 rounded-full"
          style={{
            background: "radial-gradient(circle, hsla(222,100%,60%,0.2) 0%, transparent 70%)",
            animation: "pulse-hero-glow 8s ease-in-out infinite reverse",
          }}
        />
      </div>
