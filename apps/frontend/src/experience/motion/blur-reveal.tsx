  ...
  return (
    <div
      ...
      style={{
        ...
        transition: `opacity ${MOTION_TOKENS.duration.normal}s cubic-bezier(${MOTION_TOKENS.ease.outExpo.join(",")}), filter ${MOTION_TOKENS.duration.slow}s cubic-bezier(${MOTION_TOKENS.ease.outExpo.join(",")}), transform ${MOTION_TOKENS.duration.normal}s cubic-bezier(${MOTION_TOKENS.ease.outExpo.join(",")})`,
