  ...
  projects: {
    ...
    projects: {
      ...
      list: (filters: Record<string, unknown>) =>
        ["projects", "projects", "list", filters] as const,
    ...
    timelogs: {
      ...
      list: (filters: Record<string, unknown>) =>
        ["projects", "timelogs", "list", filters] as const,
    },
  },
  team: {
    ...
    organizations: {
      ...
      list: (filters: Record<string, unknown>) =>
        ["team", "organizations", "list", filters] as const,
    },
    members: {
    ...
    conversations: {
      ...
      list: (filters: Record<string, unknown>) =>
        ["team", "conversations", "list", filters] as const,
    },
  },
  client_portal: {
    ...
    users: {
      ...
      list: (filters: Record<string, unknown>) =>
        ["client_portal", "users", "list", filters] as const,
    },
    deliverables: {
      all: ["client_portal", "deliverables"] as const,
      list: (filters: Record<string, unknown>) =>
        ["client_portal", "deliverables", "list", filters] as const,
    },
    messages: {
      all: ["client_portal", "messages"] as const,
      list: (filters: Record<string, unknown>) =>
        ["client_portal", "messages", "list", filters] as const,
    },
    surveys: {
      all: ["client_portal", "surveys"] as const,
      list: (filters: Record<string, unknown>) =>
        ["client_portal", "surveys", "list", filters] as const,
    },
    signatures: {
      all: ["client_portal", "signatures"] as const,
      list: (filters: Record<string, unknown>) =>
        ["client_portal", "signatures", "list", filters] as const,
    },
  },
  notifications: {
    messages: {
      ...
      list: (filters: Record<string, unknown>) =>
        ["notifications", "messages", "list", filters] as const,
    },
    preferences: {
      all: ["notifications", "preferences"] as const,
      list: (filters: Record<string, unknown>) =>
        ["notifications", "preferences", "list", filters] as const,
    },
    announcements: {
      all: ["notifications", "announcements"] as const,
      list: (filters: Record<string, unknown>) =>
        ["notifications", "announcements", "list", filters] as const,
    },
  },
  finance: {
    invoices: {
    ...
    estimates: {
      ...
      list: (filters: Record<string, unknown>) =>
        ["finance", "estimates", "list", filters] as const,
    },
    expenses: {
    ...
    subscriptions: {
      ...
      list: (filters: Record<string, unknown>) =>
        ["finance", "subscriptions", "list", filters] as const,
    },
  },
  analytics: {
