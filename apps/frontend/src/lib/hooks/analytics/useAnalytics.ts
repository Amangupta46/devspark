...
import {
  getDashboardMetrics, getRevenueCharts,
  getPipelineCharts, getTaskCharts, getProjectCharts
...
export function usePrefetchDashboard() {
  ...
  return async () => {
    await Promise.all([
      queryClient.prefetchQuery({ queryKey: queryKeys.analytics.dashboard, queryFn: getDashboardMetrics, staleTime: CHART_STALE_TIME }),
      queryClient.prefetchQuery({ queryKey: queryKeys.analytics.charts.revenue, queryFn: getRevenueCharts, staleTime: CHART_STALE_TIME }),
      queryClient.prefetchQuery({ queryKey: queryKeys.analytics.charts.pipeline, queryFn: getPipelineCharts, staleTime: CHART_STALE_TIME }),
      queryClient.prefetchQuery({ queryKey: queryKeys.analytics.charts.tasks, queryFn: getTaskCharts, staleTime: CHART_STALE_TIME }),
      queryClient.prefetchQuery({ queryKey: queryKeys.analytics.charts.projects, queryFn: getProjectCharts, staleTime: CHART_STALE_TIME }),
    ]);
  };
}
